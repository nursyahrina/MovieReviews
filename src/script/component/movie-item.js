...
class MovieItem extends HTMLElement {
	...
	render() {
		...
		<section class="movie media flex-wrap shadow rounded-lg p-4 mt-4">
            ...
            <div class="media-body d-flex flex-column align-items-stretch m-2">
                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <a class="btn btn-primary align-self-end mb-3 px-3" data-toggle="collapse" 
        ...
        <div class="collapse bg-light p-3" id="collapseReviews${this._movie.id}">
            <!-- Reviews -->
        </div>
        `;
